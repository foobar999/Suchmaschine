...
if __name__ == '__main__':
    ...
    corr = MembershipCalculator().calc_correlation_mat(dictionary, 0.5) # last run: built correlation matrix in 1588.62204 seconds (~26min) (ich glaube die andere gruppe sprach so von 20min)
