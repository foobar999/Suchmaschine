...
class MembershipCalculator(object):
    ...
    # Jaccard-Maﬂ einen Wert >= threshold ergibt
    ...
    #===========================================================================
        ...
        #out = np.triu(out, k=0)  # setze Elemente in oberer Dreicksmatrix (auﬂerhalb Diagonale) 0
...
#===============================================================================
    ...
    # benˆtigt die Korrelationsmatrix corr und eine Schwelle threshold
    # der Fuzzy-Index wird durch ein dict repr‰sentiert
    # das dict speichert zu jedem Term t eine RankedPosting-list
    # jedes RankedPosting speichert ein Dokument dok und den Fuzzy-Zugehˆrigkeitsgrad W(D,t)    # also genau anderes als in der vorlesung ;) (W(t,D)) [macht aber auch sinn]
