...
class AndProcessor(QueryOperatorProcessor):
    ...
    # jedes Literal ist entweder positiv und enth�lt das Ergebnis der Auswertung des Knotens
    # oder es ist negatic und es enth�lt das Ergebnis der Auswertung des 1 Kindsknotens vom NOT-Knoten
    ...
    def process(self, nodes, universe):
        ...
        for i in range(1, len(sorted_literals)):
            ...
            # falls leere Menge das Zwischenergebnis => gib es direkt zur�ck    
